...
if($_GET) {
  switch ($_GET['page']){
    ...
    case 'Tipe-Data' :
    if(!file_exists ('pages/admin/tipe/tipe_data.php')) die ($nopage);
    include 'pages/admin/tipe/tipe_data.php';	break;

    case 'Tipe-Ubah' :
    if(!file_exists ('pages/admin/tipe/tipe_ubah.php')) die ($nopage);
    include 'pages/admin/tipe/tipe_ubah.php';	break;

    case 'Tipe-Hapus' :
    if(!file_exists ('pages/admin/tipe/tipe_hapus.php')) die ($nopage);
    include 'pages/admin/tipe/tipe_hapus.php';	break;

    case 'Kategori-Data' :
    if(!file_exists ('pages/admin/kategori/kategori_data.php')) die ($nopage);
    include 'pages/admin/kategori/kategori_data.php';	break;

    case 'Kategori-Ubah' :
    if(!file_exists ('pages/admin/kategori/kategori_ubah.php')) die ($nopage);
    include 'pages/admin/kategori/kategori_ubah.php';	break;

    case 'Kategori-Hapus' :
    if(!file_exists ('pages/admin/kategori/kategori_hapus.php')) die ($nopage);
    include 'pages/admin/kategori/kategori_hapus.php';	break;
